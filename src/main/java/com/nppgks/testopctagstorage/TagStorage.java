...
public class TagStorage {
    ...
    TagStorage(){
        ...
        putMi3272usedTprInKpSoiSubrange();
    ...
    public void putMi3272Pep(){
        tagData.put("mi3272.measureCount", "5");
        tagData.put("mi3272.seriesCount", "5");
        tagData.put("mi3272.pointsCount", "5");
        tagData.put("mi3272.usedTPR", "false");
        ...
        String Q_ij = """
                [[228.410416,227.159958,226.100906,225.697845,225.362869],
                [332.639801,332.666534,332.653748,332.653748,332.656799],
                [430.062317,430.015839,430.035126,430.000946,429.946899],
                [523.972168,523.933899,523.920105,523.730164,523.786682],
                [633.228271,632.652954,632.590637,632.502502,632.599976]]
                """;
        String N_mas_ij = """
                ...
                """;
        String N_TPR_ij_zad = """
                [[10010,10015,10027,10013,10006],
                [10018,10012,10001,10022,10024],
                [10034,10024,10009,10015,10016],
                [10013,10022,10027,10005,10017],
                [10011,10021,10028,10033,10018]]
                """;
        String t_TPR_ij = """
                [[13.202753,13.205186,13.203438,13.174415,13.152116],
                [13.698619,13.713170,13.717439,13.720113,13.720798],
                [13.109147,13.114634,13.117617,13.118594,13.118944],
                [13.585393,13.592384,13.591421,13.600593,13.598331],
                [13.912652,13.919135,13.929363,13.938115,13.942874]]
                """;
        String P_TPR_ij = """
                [[1.398866,1.411907,1.424124,1.428399,1.432116],
                [1.272041,1.272327,1.272116,1.272278,1.271900],
                [1.638925,1.639054,1.639163,1.639190,1.639169],
                [2.501287,2.501369,2.501683,2.501813,2.501837],
                [2.376389,2.377975,2.379580,2.380173,2.380347]]
                """;
