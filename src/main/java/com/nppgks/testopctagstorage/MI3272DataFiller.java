...
public class MI3272DataFiller {
    ...
    public static Map<String, String> putRestInitDataWithTpr() {
        ...
        String rho2_BIK_ij_avg = """
                ...
                """;
        tagData.put("mi3272.rho_BIK_ij_avg", rho2_BIK_ij_avg.replaceAll("\n", ""));
    ...
    public static Map<String, String> putRestInitDataWithTprInKPPPInBIKSOI() {
        ...
        String t2_PP_ij_avg = """
                [[14.277812,13.298722,13.250914,14.255547,13.245632],
                [13.251566,13.29077,13.237999,14.276176,14.281322],
                [13.231817,13.235448,13.229321,14.212112,14.205733],
                [13.27814,14.200424,14.29593,13.284877,13.249242],
                [13.286108,13.299001,13.280737,14.219036,13.282256]]
                """;
        tagData.put("mi3272.t_PP_ij_avg", t2_PP_ij_avg.replaceAll("\n",""));

        String P2_PP_ij_avg = """
                [[1.240954,1.277306,2.243961,1.289683,1.239511],                     
                [2.299373,2.273227,1.277053,1.743429,1.232955],
                [2.677956,2.161577,1.898914,1.915351,2.659461],
                [2.257665,1.633045,1.21419,2.657081,2.274055],
                [2.268542,2.106016,2.292569,2.200775,2.482038]]
                """;
        tagData.put("mi3272.P_PP_ij_avg", P2_PP_ij_avg.replaceAll("\n",""));
    ...
    public static Map<String, String> putRestInitDataWithTprNotInKPPPInBIKSOI() {
        ...
        String t_KP_ij = """
                [[13.7001,13.5131,13.3286,13.8379,13.4089,13.1923,13.3682,13.3941,13.8553,13.1699],
                [13.2857,13.7555,13.3805,13.9101,13.391,13.7447,13.7359,13.8945,13.7661,13.7935],
                [13.9849,13.7979,13.3516,13.9899,13.5102,13.4182,13.1366,13.4476,13.6249,13.3933],
                [13.4753,13.2509,13.2278,13.651,13.5471,13.9757,13.2788,13.3997,13.9867,13.3356],
                [13.1423,13.931,13.7452,13.4228,13.9229,13.6128,13.5981,13.6813,13.2357,13.4968]]
                """;
        tagData.put("mi3272.t_KP_ij", t_KP_ij.replaceAll("\n",""));

        String P_KP_ij = """
                [[2.454606,1.924963,2.456482,2.334304,2.039055,1.653375,1.857809,1.62003,2.100202,1.71178],
                [1.980524,1.68169,2.423952,1.970846,2.373838,1.588707,2.541267,1.560877,2.309754,2.023269],
                [2.090876,1.8018,1.976977,2.446261,1.717764,2.495572,1.687668,2.544935,2.10364,2.257235],
                [1.871473,1.953241,2.271505,2.530171,2.281493,1.62109,1.700297,2.450558,2.364003,2.089872],
                [2.313289,2.208755,1.744523,2.115477,2.305685,2.543481,1.732175,2.290486,1.696335,2.059448]]
                """;
        tagData.put("mi3272.P_KP_ij", P_KP_ij.replaceAll("\n",""));
