...
public class MI3272DataFiller {
    public static void putTprCoeffInitData(Map<String, String> tagData, boolean tprInKp, boolean ppInKp) {
    ...
    public static void putRestInitDataWithTpr(Map<String, String> tagData) {
    ...
    public static void putWithoutTprPep(Map<String, String> tagData, boolean ppInKp) {
        tagData.put("mi3272.PPInKP", String.valueOf(ppInKp));
        tagData.put("mi3272.calibrCharImpl", "ПЭП");
